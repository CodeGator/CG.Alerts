...
{
    /// <summary>
    /// This class is a default handler for an warning alert event.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// To create a custom handler for warning alerts, simply derive from this 
    ...
    /// </remarks>
    /// <example>
    /// Here is an example of creating a custom warning alert handler:
    /// <code>
    /// public class MyWarningHandler : WarningAlert
    /// {
    ...
    /// </code>
    /// </example>
    public class WarningAlert : AlertEventBase
    {
        // *******************************************************************
        // Fields.
        // *******************************************************************
        ...
        /// <summary>
        /// This constructor creates a new instance of the <see cref="WarningAlert"/>
        /// class.
        /// </summary>
        /// <param name="logger">The logger to use with the alert.</param>
        public WarningAlert(
            ILogger<WarningAlert> logger
            )
        {
        ...
        /// <summary>
        /// This method is overridden in order process incoming warning alerts.
        /// </summary>
